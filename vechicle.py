...
# Algorithum for subtracting the vechicle 
...
# Web camera Imlementation
while True:
    # Algorithum for subtracting the vechicle - 2
    ret,frame1= cap.read()
    ...
    for (i,c) in enumerate(counterShape):
        ...
        # detected number shown on window
        for(x,y) in detect:
    ...
    # cv2.imshow('Destector', dilatada)
    # Web camera Imlementation - 2
